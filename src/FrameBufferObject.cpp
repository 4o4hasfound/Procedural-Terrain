...
FrameBufferOBJ::FrameBufferOBJ(int W_, int H_) {
	this->W = W_;
	this->H = H_;
...
FrameBufferOBJ::FrameBufferOBJ(int W_, int H_, const int nColorAttachments) {
	this->W = W_;
	this->H = H_;
	this->FBO = createFrameBuffer();
...
unsigned int FrameBufferOBJ::getColorAttachmentTex(int i) {
